...
module.exports = {
  ...
  module: {
    noParse: /node_modules\/(jquey|moment|chart\.js)/, //忽略解析.
    loaders: [
      {
        test: /\.jsx?$/,
        loader: 'babel-loader',
        ...
        include: [
          APP_PATH,
          path.resolve(ROOT_PATH, 'node_modules/bootstrap/scss/')
        ]
      }, {
  ...
  plugins: [
    new HtmlWebpackPlugin({template: `${APP_PATH}/index.html`, filename: 'index.html', inject: 'body'}),
